    ...
    <footer className="bg-slate-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold font-sans">MediCompare</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/"><a className="text-slate-400 hover:text-white transition">Home</a></Link></li>
              <li><Link href="/#how-it-works"><a className="text-slate-400 hover:text-white transition">How It Works</a></Link></li>
              <li><Link href="/#features"><a className="text-slate-400 hover:text-white transition">Features</a></Link></li>
              <li><Link href="/#join-waitlist"><a className="text-slate-400 hover:text-white transition">Join Waitlist</a></Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@medicompare.com" className="text-slate-400 hover:text-white transition">info@medicompare.com</a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-slate-800 pt-6 text-center text-slate-500 text-sm">
          <p>© {new Date().getFullYear()} MediCompare. All rights reserved.</p>
          <p className="mt-2">
            <strong>Disclaimer:</strong> MediCompare provides information about medication alternatives and pricing for educational purposes only. 
